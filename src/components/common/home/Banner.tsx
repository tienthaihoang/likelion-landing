  ...
  return (
    <section className="realative w-full">
      ...
      <div className="relative w-full min-h-[80vh]">
        <Image
          src="https://res.cloudinary.com/do6l2audn/image/upload/v1747623355/Homepage_Banner_qptapa.png"
      ...
      {/* Achievements */}
      <div className="z-20 md:-translate-y-1/2 md:-translate-x-1/2 md:container md:absolute left-1/2">
        <Achievements />
      </div>
    </section>
  );
